...
// Course pages
import EquipmentOperations from './pages/courses/EquipmentOperations';
import FireSafety from './pages/courses/FireSafety';
import MaritimeSeamanship from './pages/courses/MaritimeSeamanship';
import Technical1 from './pages/courses/Technical1';
import Technical2 from './pages/courses/Technical2';
import Management from './pages/courses/Management';
import CraneOperatorTraining from './pages/courses/CraneOperatorTraining';
import CraneOperatorTraining2 from './pages/courses/CraneOperatorTraining2';
import ForkliftTugOperations from './pages/courses/ForkliftTugOperations';
import MoversOperators from './pages/courses/MoversOperators';
import InformationSystems from './pages/courses/InformationSystems';
                    ...
                    <main className="main-content">
                      {isLoading ? (
                        ...
                        <Routes>
                           ...
                           <Route path="/mahapolaports/admin" element={<AdminLogin />} />
                           <Route path="/mahapolaports/admin/dashboard" element={<AdminDashboard />} />
                           <Route path="/mahapolaports/admin/add-course" element={<AddCourse />} />
